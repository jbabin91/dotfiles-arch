...
(defvar jbabin91/default-font-size 160)
(set-face-attribute 'default nil :height jbabin91/default-font-size)

;; Custom file
(defvar jbabin91/custom-file (expand-file-name "custom.el" user-emacs-directory))
...
(setq custom-file               jbabin91/custom-file
...
(if (file-exists-p jbabin91/custom-file)
  (load custom-file))
