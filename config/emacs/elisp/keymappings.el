...
(use-package general
  :after evil
  :config
  (general-create-definer jbabin91/leader-keys
    :keymaps '(normal insert visual emacs)
    :prefix "SPC"
    :global-prefix "C-SPC")

  (jbabin91/leader-keys
    ...
    "hK"  '(helpful-key :which-key "helpfule key")
    ...
    ;; "obt"  '(org-babel-tangle :which-key "org babel tangel")
